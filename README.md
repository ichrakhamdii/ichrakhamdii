...
## 🚀 About Me
- 🎓 Computer science engineer specialized in Data Science, graduated from Private Higher School of Engineering and Technology **ESPRIT**, Tunisia.
- 💼 Currently a Junior AI Engineer at Perf Analysis Consulting, building real-time computer vision and generative AI systems for sports analytics.
- 🌱 Refining my skills in LLMs, RAG, and production ML deployment.
- 👯 Looking to collaborate on computer vision, NLP, and generative AI projects.
- 🤔 Open to new AI Engineer opportunities.
- 📫 How to reach me: ichrak.hamdi@esprit.tn
- ⚡ Fun fact: I enjoy diving deep into data to uncover hidden patterns and insights.

## 🛠️ Skills 
- **Programming:** Python, R, SQL
- **AI / ML:** PyTorch, TensorFlow, Scikit-Learn, Hugging Face Transformers, Computer Vision, Deep Learning
- **NLP & Generative AI:** SpaCy, BERT, LLMs, RAG, Fine-tuning, Prompt Engineering, Vector Embeddings, NER
- **MLOps & Infra:** Pandas, NumPy, Apache Spark, Matplotlib, Seaborn, Plotly, PostgreSQL, MySQL, FastAPI, Docker, Git/GitHub, CI/CD, Jupyter Notebook
## 💻 Tech Stack:
